...
from .utils import tx_size, tx_feerate, bump_feerate
...
class Vault:
    ...
    def create_sign_unvault(self, vault):
        ...
        feerate = self.sigserver.get_feerate("cancel",
                                             dummy_tx.GetTxid().hex())
        unvault_amount = vault["amount"] - feerate * tx_size(dummy_tx)
    ...
    def create_sign_cancel(self, vault):
        ...
        feerate = self.sigserver.get_feerate("cancel",
                                             dummy_tx.GetTxid().hex())
        cancel_amount = unvault_amount - feerate * tx_size(dummy_tx)
    ...
    def create_sign_unvault_emer(self, vault):
        ...
        feerate = self.sigserver.get_feerate("emergency",
                                             dummy_tx.GetTxid().hex())
        emer_amount = unvault_amount - feerate * tx_size(dummy_tx)
